...
The public API lives at the module root (`github.com/go-ruby-aasm/aasm`). It is
**Ruby-shaped but Go-idiomatic**: names mirror Ruby's `aasm`, while the surface follows
...
```go
import "github.com/go-ruby-aasm/aasm"
```
...
- **[pkg.go.dev/github.com/go-ruby-aasm/aasm](https://pkg.go.dev/github.com/go-ruby-aasm/aasm)**

The module's [README](https://github.com/go-ruby-aasm/aasm#readme) carries worked
