...
Contributions are welcome. `go-ruby-aasm/aasm` is built to a small set of
...
The library is in [`github.com/go-ruby-aasm/aasm`](https://github.com/go-ruby-aasm/aasm).
This documentation site is in [`github.com/go-ruby-aasm/docs`](https://github.com/go-ruby-aasm/docs).
